...
OutFile "Kate-setup-15.12-debug.exe"
...
Section "Kate" SEC01
  ...
  SetOverwrite try
  File "bin\bearer\qgenericbearerd.dll"
  File "bin\bearer\qnativewifibearerd.dll"
  SetOutPath "$INSTDIR\bin"
  File "bin\breeze.rcc"
  File "bin\d3dcompiler_47.dll"
  SetOutPath "$INSTDIR\bin\iconengines"
  File "bin\iconengines\qsvgicond.dll"
  SetOutPath "$INSTDIR\bin"
  File "bin\iconv.dll"
  SetOutPath "$INSTDIR\bin\imageformats"
  File "bin\imageformats\qddsd.dll"
  File "bin\imageformats\qgifd.dll"
  File "bin\imageformats\qicnsd.dll"
  File "bin\imageformats\qicod.dll"
  File "bin\imageformats\qjp2d.dll"
  File "bin\imageformats\qjpegd.dll"
  File "bin\imageformats\qmngd.dll"
  File "bin\imageformats\qsvgd.dll"
  File "bin\imageformats\qtgad.dll"
  File "bin\imageformats\qtiffd.dll"
  File "bin\imageformats\qwbmpd.dll"
  File "bin\imageformats\qwebpd.dll"
  SetOutPath "$INSTDIR\bin"
  File "bin\kate.exe"
  ...
  File "bin\platforms\qwindowsd.dll"
  SetOutPath "$INSTDIR\bin\printsupport"
  File "bin\printsupport\windowsprintersupportd.dll"
  SetOutPath "$INSTDIR\bin"
  File "bin\qt.conf"
  File "bin\Qt5Cored.dll"
  File "bin\Qt5DBusd.dll"
  File "bin\Qt5Guid.dll"
  File "bin\Qt5Networkd.dll"
  File "bin\Qt5PrintSupportd.dll"
  File "bin\Qt5Scriptd.dll"
  File "bin\Qt5Svgd.dll"
  File "bin\Qt5Widgetsd.dll"
  File "bin\Qt5Xmld.dll"
...
Section Uninstall
  ...
  Delete "$INSTDIR\bin\Qt5Xmld.dll"
  Delete "$INSTDIR\bin\Qt5Widgetsd.dll"
  Delete "$INSTDIR\bin\Qt5Svgd.dll"
  Delete "$INSTDIR\bin\Qt5Scriptd.dll"
  Delete "$INSTDIR\bin\Qt5PrintSupportd.dll"
  Delete "$INSTDIR\bin\Qt5Networkd.dll"
  Delete "$INSTDIR\bin\Qt5Guid.dll"
  Delete "$INSTDIR\bin\Qt5DBusd.dll"
  Delete "$INSTDIR\bin\Qt5Cored.dll"
  Delete "$INSTDIR\bin\qt.conf"
  Delete "$INSTDIR\bin\printsupport\windowsprintersupportd.dll"
  Delete "$INSTDIR\bin\platforms\qwindowsd.dll"
  Delete "$INSTDIR\bin\opengl32sw.dll"
  Delete "$INSTDIR\bin\libintl.dll"
  Delete "$INSTDIR\bin\libGLESV2d.dll"
  Delete "$INSTDIR\bin\libEGLd.dll"
  ...
  Delete "$INSTDIR\bin\iconengines\qsvgicond.dll"
  Delete "$INSTDIR\bin\d3dcompiler_47.dll"
  Delete "$INSTDIR\bin\breeze.rcc"
  Delete "$INSTDIR\bin\bearer\qnativewifibearerd.dll"
  Delete "$INSTDIR\bin\bearer\qgenericbearerd.dll"
